...
@Component({
  selector: 'app-corporate-account-list',
  templateUrl: './corporate-account-list.component.html',
  styleUrls: ['./corporate-account-list.component.css']
})
export class CorporateAccountListComponent {
  ...
  getUsersList() {
    ...
    this.userSessionDetails.userType = 3; // 3 i used to get Corps users
