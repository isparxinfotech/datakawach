...
export class SuperAdminService {
  ...
  constructor(private http: HttpClient) { }
    ...
    return this.http.post<GetPersonalInfoRequest>(`https://datakavach.com:8080/api/auth/getUserList`,model)
  }

  updateUser(username: string, user: any): Observable<any> {
    return this.http.put(`https://datakavach.com:8080/api/auth/users/${username}`, user);
  }
}
